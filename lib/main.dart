...
import 'package:toll_gates/src/pages/account_details.dart';
import 'package:toll_gates/src/pages/dashboard.dart';
import 'package:toll_gates/src/pages/login.dart';
import 'package:toll_gates/src/pages/new_account.dart';
import 'package:toll_gates/src/pages/new_vehicle.dart';
import 'package:toll_gates/src/pages/search_account.dart';
import 'package:toll_gates/src/pages/tag_scanner.dart';
import 'package:toll_gates/src/pages/vehicle_enrollment.dart';
...
class Splash2 extends StatelessWidget {
  ...
  Widget SplashScreen({required int seconds, required navigateAfterSeconds, required Image image, required AssetImage imageBackground, required Text loadingText, required double photoSize, required MaterialColor loaderColor}) {}
}