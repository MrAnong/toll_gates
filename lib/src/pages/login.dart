...
//   }
  ...
  LoginTheme({required MaterialAccentColor primaryColor, required TextStyle titleStyle}) {}

  LoginMessages({required String usernameHint, required String passwordHint, required String confirmPasswordHint, required String loginButton, required String signupButton, required String recoverPasswordSuccess}) {}

  FlutterLogin({required String title, required messages, required Null Function(dynamic value) emailValidator, required String logo, required Future<String> Function(dynamic loginData) onLogin, required Null Function() onSubmitAnimationCompleted, required Future Function(dynamic _) onRecoverPassword, required theme}) {}
