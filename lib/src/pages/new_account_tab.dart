...
class _SearchAccountState extends State<SearchAccount2> {
  ...
  static List<User> users = List<User>();
  bool loading = true;
    ...
    return Form(
      child: Padding(
        ...
        child: Column(
          ...
          children: <Widget>[
            if (loading) CircularProgressIndicator() else searchTextField = AutoCompleteTextField<User>(
  ...
  AutoCompleteTextField({required GlobalKey<dynamic> key, required bool clearOnSubmit, required List<User> suggestions, required TextStyle style, required InputDecoration decoration, required Function(dynamic item, dynamic query) itemFilter, required Function(dynamic a, dynamic b) itemSorter, required Null Function(dynamic item) itemSubmitted, required Container Function(dynamic context, dynamic item) itemBuilder}) {}
}
