...
class _FormExampleState extends State<FormExample> {
  ...
  TextFieldConfiguration({required InputDecoration decoration, required TextEditingController controller}) {}
}
...
class ScrollExample extends StatelessWidget {
  ...
  TextFieldConfiguration({required InputDecoration decoration}) {}

  TypeAheadField({required bool getImmediateSuggestions, required textFieldConfiguration, required Future<List<String>> Function(String pattern) suggestionsCallback, required ListTile Function(dynamic context, String suggestion) itemBuilder, required Null Function(String suggestion) onSuggestionSelected}) {}
}
